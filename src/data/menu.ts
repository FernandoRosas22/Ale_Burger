...
import sliders from "@/assets/3x2.BURGERS.DOBLES.jpg";
...
export const menu: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { nombre: "GOLDEN BURGER", desc: "Pan de papa, cheddar x2, ketchup, mostaza, cebolla brunoise, panceta crocante, carne smash y pickles.", precio: "$13.050", precioAnt: "$14.500", tag: "10% OFF", emoji: "🍔", img: goldenBurger },
      ...
      { nombre: "SLIDERS", desc: "Pan de papa, cheddar y carne smash. Mini burger ideal para compartir.", precio: "$4.000", tag: "Mini", emoji: "🍔", img: sliders },
    ],
  },
  {
    id: "bebidas",
  ...
  },
  {
    ...
    items: [
      { nombre: "PAPAS CHICAS", desc: "150grs de la mejor papa.", precio: "$2.700", precioAnt: "$3.000", tag: "10% OFF", emoji: "🍟", img: papasChicas },
      { nombre: "BANDEJA DE PAPAS", desc: "350grs de papas crocantes.", precio: "$5.400", precioAnt: "$6.000", tag: "Para compartir", emoji: "🍟", img: bandejaPapas },
      { nombre: "AROS DE CEBOLLA", desc: "10 aros de cebolla por bandeja (150grs).", precio: "$6.750", precioAnt: "$7.500", tag: "Crispy", emoji: "🧅", img: arosCebolla },
